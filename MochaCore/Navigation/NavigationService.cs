...
namespace MochaCore.Navigation
{
    ...
    {
        private readonly List<INavigationModule> _cachedModules = new();
        ...
        private void SetupRequestedModule(NavigationData navigationData)
        {
        ...
        private class NavigationModuleInternalComparer : IEqualityComparer<INavigationModule>
        {
            ...
            public int GetHashCode(INavigationModule obj)
            {
                ...
                hashCode = hashCode * -1521134295 + EqualityComparer<object>.Default.GetHashCode(obj.View ?? 0);
