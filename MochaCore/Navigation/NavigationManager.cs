...
namespace MochaCore.Navigation
{
    ...
    public static class NavigationManager
    {
        ...
        /// <summary>
        /// Stores the function that creates the <see cref="INavigationModule"/> implementation 
        /// which is used later by the technology-independent layer.
        /// </summary>
        /// <param name="id">
        ...
        /// </param>
        /// <param name="navigationViewDelegate">A delegate which creates a <see cref="INavigationModule"/> instance.</param>
