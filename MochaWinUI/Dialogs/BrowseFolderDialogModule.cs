...
namespace MochaWinUI.Dialogs
{
    ...
    public class BrowseFolderDialogModule : BrowseBaseDialogModule<FolderPicker, StorageFolder, BrowseFolderDialogProperties>
    {
        ...
        /// </summary>
        public BrowseFolderDialogModule() : base(new BrowseFolderDialogProperties(), new FolderPicker()) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="BrowseFolderDialogModule"/> class.
        /// </summary>
        /// <param name="properties">Statically typed properties object which serves for configuration of this module.</param>
        public BrowseFolderDialogModule(BrowseFolderDialogProperties properties) : base(properties, new FolderPicker()) { }
        ...
        public BrowseFolderDialogModule(BrowseFolderDialogProperties properties, FolderPicker view) : base(properties, view) { }
