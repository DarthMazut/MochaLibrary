...
namespace MochaWPF.Prototypes
{
    ...
    /// </summary>
    public class CustomDialogModulePrototype : BaseDialogModule
    {
        ...
        public CustomDialogModulePrototype(Application application, Window window, IDialog dataContext) : base(application, dataContext)
        {
            _view = window;
